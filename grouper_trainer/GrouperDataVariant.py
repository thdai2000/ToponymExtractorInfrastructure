...
class GrouperDataset:
    ...
    def yield_samples(self, img_ids, sample_ratio, augmentation=True, variant_length=False):
        ...
        for img_id in img_ids:
            ...
            for sample in samples:
                ...
                query_font = sample['word'].get('font_embed', [])
                ...
                for neighbour in sample['dictionary']:
                    ...
                    neighbour_font.append(neighbour.get('font_embed', []))
    ...
    def get_dataset(self, sample_ratio=1.0):

        dataset = self.yield_samples(list(self.images.keys()), sample_ratio=sample_ratio, augmentation=False, variant_length=True)
